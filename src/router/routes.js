...
const routes = [
  ...
  // },
  {
    ...
    children: [
      { path: '', component: () => import('../pages/HomeTEST.vue') },
...

  {
    ...
    children: [
      ...
      { path: 'local-page', component: () => import('src/testpage/LocalPage.vue') },
      { path: 'student', component: () => import('src/testpage/StudentList.vue') },
      { path: 'student-form/:studentId', component: () => import('src/testpage/StudentForm.vue') },
      { path: 'list-page', component: () => import('src/testpage/ListTest.vue') },
    ]
  },
